...
/* Act as CTRL when held but CAPS LOCK when pressed */
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_all(
    ...
    CAPS_CTRL ,           KC_A    , KC_S    , KC_D   , KC_F    , KC_G    , KC_H    , KC_J    , KC_K     , KC_L    , KC_SCLN , KC_QUOT , KC_ENT  ,                     KC_PGDN ,
  ...
  LAYOUT_all(
    ...
    KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , BL_BRTG , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS , KC_TRNS ,                          BL_INC  ,
    KC_TRNS , KC_TRNS , KC_TRNS ,                               BL_TOGG ,                               KC_TRNS , KC_TRNS ,                          KC_TRNS , BL_DEC  , KC_TRNS
  ),
